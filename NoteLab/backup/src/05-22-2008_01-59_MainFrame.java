                                                 ...
                                                 ProgressListener
{
   ...
   public MainFrame(CompositeCanvas canvas)
   {
      ...
      this.twinWindow = new JFrame();
      this.twinWindow.setUndecorated(true);
      this.twinWindow.setLayout(new GridLayout(1,1));
      
      //Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
      
      Dimension screenSize = new Dimension(1400-1, 1050-1);
      
      this.twinWindow.setSize(screenSize);
      this.twinWindow.setPreferredSize(screenSize);
      
      this.twinWindow.setAlwaysOnTop(false);
      this.twinWindow.setModalExclusionType(ModalExclusionType.TOOLKIT_EXCLUDE);
      
      this.twinWindow.setFocusable(false);
...
//               screen.setFullScreenWindow(this.twinWindow);
               ...
               this.twinWindow.setVisible(true);
               setVisible(false);
            }
            else
            {
